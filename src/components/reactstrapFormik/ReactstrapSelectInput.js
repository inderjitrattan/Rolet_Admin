        ...
        {Array.isArray(selectedItems) ? (
          ...
          <Input
            ...
            value={
              t(
                (() => {
                  if (props.inputprops?.isTranslationSelect) {
                    return (
                      props.inputprops?.value?.name ||
                      list?.find((item) => item.slug === field.value)?.name
                    );
                  } else if (setvalue !== undefined) {
                    return props.inputprops.value || selectedItems?.name;
                  } else {
                    return (
                      props.inputprops?.options?.find((item) => item.id === field.value)
                        ?.name || ""
                    );
                  }
                })()
