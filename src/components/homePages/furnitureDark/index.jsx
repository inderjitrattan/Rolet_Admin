...
const FurnitureDarkForm = ({ title, apiData }) => {
  ...
  const { data, isLoading } = useQuery({ queryKey: [HomePageAPI], queryFn: () => request({ url: HomePageAPI, params: { slug: "furniture_dark" } }), refetchOnWindowFocus: false, select: (res) => res.data });
