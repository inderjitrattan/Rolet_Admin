...
const FashionSevenSubmit = (values, mutate) => {
  ...
  if (values["banner1Image"]) {
    values["content"]["featured_banners"]["banner_1"]["image_url"] = values[
      `banner1Image`
    ].hasOwnProperty("asset_url")
  ...
  if (values["banner2Image"]) {
    values["content"]["featured_banners"]["banner_2"]["image_url"] = values[
      `banner2Image`
    ].hasOwnProperty("asset_url")
  ...
  if (values["banner3Image"]) {
    values["content"]["featured_banners"]["banner_3"]["image_url"] = values[
      `banner3Image`
    ].hasOwnProperty("asset_url")
  ...
  if (values["productBannerImage"]) {
    values["content"]["product_banner"]["image_url"] = values[
      `productBannerImage`
    ].hasOwnProperty("asset_url")
      ? values[`productBannerImage`].asset_url
      : values[`productBannerImage`].original_url;
  } else values["content"]["product_banner"]["image_url"] = "";

  // For Passing Redirect Link
  if (values["banner1LinkType"]) {
    values["content"]["featured_banners"]["banner_1"]["redirect_link"][
      "link_type"
  ...
  if (values["banner2LinkType"]) {
    values["content"]["featured_banners"]["banner_2"]["redirect_link"][
      "link_type"
  ...
  if (values["banner3LinkType"]) {
    values["content"]["featured_banners"]["banner_3"]["redirect_link"][
      "link_type"
  ...
  if (values["productList2Product"]) {
    values["content"]["products_list_2"]["products"]["product_ids"] =
      values["productList2Product"];
  }

  if (values["productBannerProducts"]) {
    values["content"]["product_banner"]["product_ids"] =
      values["productBannerProducts"];
  }

  if (values["productList1Categories"]) {
    values["content"]["products_list_1"]["category_id"] =
      values["productList1Categories"];
  }
