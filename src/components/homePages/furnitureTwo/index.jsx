...
const FurnitureTwoForm = ({ title, apiData }) => {
  ...
  const { data, isLoading } = useQuery({ queryKey: [HomePageAPI], queryFn: () => request({ url: HomePageAPI, params: { slug: "furniture_two" } }), refetchOnWindowFocus: false, select: (res) => res.data });
