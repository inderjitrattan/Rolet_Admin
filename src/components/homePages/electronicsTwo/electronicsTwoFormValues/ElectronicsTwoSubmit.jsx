...
const ElectronicsTwoSubmit = (values, mutate) => {
  ...
  if (values["offerBanner1Image"]) {
    values["content"]["offer_banner"]["banner_1"]["image_url"] = values[
      ...
      ? values["offerBanner1Image"].asset_url
  ...
  if (values["offerBanner3Image"]) {
    values["content"]["offer_banner"]["banner_3"]["image_url"] = values[
      "offerBanner3Image"
    ].hasOwnProperty("asset_url")
      ? values["offerBanner3Image"].asset_url
      : values["offerBanner3Image"].original_url;
  } else values["content"]["offer_banner"]["banner_3"]["image_url"] = "";

  if (values["homeBanner1Image"]) {
    values["content"]["home_banner"]["banner_1"]["image_url"] = values[
      "homeBanner1Image"
    ].hasOwnProperty("asset_url")
      ? values["homeBanner1Image"].asset_url
      : values["homeBanner1Image"].original_url;
  } else values["content"]["home_banner"]["banner_1"]["image_url"] = "";

  if (values["homeBanner2Image"]) {
    values["content"]["home_banner"]["banner_2"]["image_url"] = values[
      "homeBanner2Image"
    ].hasOwnProperty("asset_url")
      ? values["homeBanner2Image"].asset_url
      : values["homeBanner2Image"].original_url;
  } else values["content"]["home_banner"]["banner_2"]["image_url"] = "";

  if (values["homeBanner3Image"]) {
    values["content"]["home_banner"]["banner_3"]["image_url"] = values[
      "homeBanner3Image"
    ].hasOwnProperty("asset_url")
      ? values["homeBanner3Image"].asset_url
