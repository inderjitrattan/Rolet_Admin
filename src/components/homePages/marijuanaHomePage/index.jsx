...
const MarijuanaHomePageForm = ({ title, apiData }) => {
  ...
  const { data, isLoading } = useQuery({ queryKey: [HomePageAPI], queryFn: () => request({ url: HomePageAPI, params: { slug: "marijuana" } }), refetchOnWindowFocus: false, select: (res) => res.data});
