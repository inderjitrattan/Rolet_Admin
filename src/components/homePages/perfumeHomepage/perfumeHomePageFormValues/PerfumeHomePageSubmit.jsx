...
const PerfumeHomePageSubmit = (values, mutate) => {
  ...
  if (values["productListLeftPanelLinkType"]) {
    values["content"]["product_list"]["left_panel"]["redirect_link"][
      "link_type"
  ...
  if (values["homeBannerImage"]) {
    values["content"]["home_banner"]["image_url"] = values[
      `homeBannerImage`
  ...
  if (values["collectionBannerImage"]) {
    values["content"]["collection_banner"]["image_url"] = values[
      `collectionBannerImage`
    ].hasOwnProperty("asset_url")
      ? values[`collectionBannerImage`].asset_url
  ...
  if (values["productListProducts"]) {
    values["content"]["product_list"]["products"]["product_ids"] =
      values["productListProducts"];
  }
  if (values["productCategory"]) {
    values["content"]["category_product"]["category_ids"] =
