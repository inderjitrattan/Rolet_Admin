...
import { SingleProductTitle } from "@/data/TabTitleList";
...
const SingleProduct = ({ title, apiData }) => {
  ...
  const { data, isLoading } = useQuery({ queryKey: [HomePageAPI], queryFn: () => request({ url: HomePageAPI, params: { slug: "single_product" } }), refetchOnWindowFocus: false, select: (res) => res.data });
