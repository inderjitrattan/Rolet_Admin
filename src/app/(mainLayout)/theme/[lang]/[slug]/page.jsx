...
const HomePages = () => {
  ...
  const {
    ...
    queryKey: [Category],
    queryFn: () => request({ url: Category, params: { type: "product" } }),
    enabled: true,
    refetchOnWindowFocus: false,
    select: (res) =>
      res?.data?.data?.map((elem) => {
  ...
  const homePageOptions = {
    ...
    surfboard: <SurfingHomePageForm title={title} apiData={apiData} />,
